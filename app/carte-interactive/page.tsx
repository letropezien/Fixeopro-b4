    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Carte Interactive Google Maps</h1>
          <p className="text-gray-600">Visualisez les demandes de réparation et les réparateurs avec Google Maps</p>
        </div>
