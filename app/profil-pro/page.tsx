...
import { Building, Camera, Star, Globe, Facebook, Instagram, Linkedin, Award, ImageIcon } from "lucide-react"
...
export default function ProfilProPage() {
  ...
  const handleSaveProfile = () => {
    ...
    const updatedUser = {
      ...
      professional: {
        ...
        companyPhotos: proProfile.companyPhotos,
      },
  ...
  const handleCompanyPhotosChange = (photos: string[]) => {
    setProProfile({ ...proProfile, companyPhotos: photos })
  }
  ...
  const trialDaysRemaining = StorageService.getTrialDaysRemaining(currentUser)
  const trialEndDate = StorageService.getTrialEndDate(currentUser)
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Gérez votre présence professionnelle sur Fixeo.pro</p>
        </div>
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Ajoutez une photo de profil professionnelle</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Ajoutez jusqu'à 5 photos pour présenter votre entreprise, vos équipements et vos réalisations
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <PhotoUpload
                    currentPhotos={proProfile.companyPhotos}
                    onPhotosChange={handleCompanyPhotosChange}
                    multiple={true}
                    maxPhotos={5}
                    label="Photos de présentation"
                    description="Montrez votre atelier, vos équipements, votre équipe ou vos réalisations"
                  />
                </CardContent>
              </Card>
          ...
          <TabsContent value="portfolio">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Vos photos d'entreprise sont affichées ici. Vous pouvez les modifier dans l'onglet Profil.
                </CardDescription>
              </CardHeader>
              <CardContent>
                {proProfile.companyPhotos.length > 0 ? (
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    {proProfile.companyPhotos.map((photo, index) => (
                      <div key={index} className="aspect-square rounded-lg overflow-hidden bg-gray-100">
                        <img
                          src={photo || "/placeholder.svg"}
                          alt={`Photo entreprise ${index + 1}`}
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                    ...
                    <h3 className="text-lg font-medium mb-2">Aucune photo d'entreprise</h3>
                    <p className="text-gray-600 mb-4">
                      Ajoutez des photos dans l'onglet Profil pour présenter votre entreprise
                    </p>
                  </div>
                )}
                ...
                <div className="mt-6">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    ...
                    <li>• Présentez votre atelier ou local professionnel</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="subscription">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Gérez votre abonnement Fixeo.pro</CardDescription>
              </CardHeader>
                ...
                <div className={`p-4 rounded-lg ${isInTrial ? "bg-green-50" : "bg-blue-50"}`}>
                  ...
                  {isInTrial ? (
                    <p className="text-green-800 text-sm mb-3">
                      Votre période d'essai gratuite se termine le {trialEndDate} ({trialDaysRemaining} jours restants)
                    </p>
                  ) : subscriptionStatus === "active" ? (
