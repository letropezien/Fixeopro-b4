  ...
  static getDefaultCategories(): Category[] {
    return [
      ...
      },
      {
        ...
        enabled: true,
        image: "/images/categories/electronique.png",
        subCategories: [
      ...
      },
      {
        ...
        enabled: true,
        image: "/images/categories/vitrerie.png",
        subCategories: [
      ...
      },
      {
        ...
        enabled: true,
        image: "/images/categories/menuiserie.png",
        subCategories: [
      ...
      },
      {
        ...
        enabled: true,
        image: "/images/categories/nettoyage.png",
        subCategories: [
      ...
      },
      {
        ...
        enabled: true,
        image: "/images/categories/demenagement.png",
        subCategories: [
    ...
    try {
      ...
      if (!storedCategories) {
        ...
        if (categories.length !== defaultCategories.length) {
          console.log("Nombre de catégories incorrect, rechargement des catégories par défaut")
  ...
  static resetCategories(): void {
    try {
      if (typeof window !== "undefined" && typeof localStorage !== "undefined") {
        ...
        console.log("Catégories réinitialisées avec succès - 16 catégories restaurées")
      }
    } catch (error) {
